...
def parse_args():
    ...
    parser.add_argument("--h_values", help='Range of values for h (start, stop, n_step)', type=int, nargs=3, default=[1,3,3])
    parser.add_argument("--m_values", help='Range of values for m (start, stop, n_step)', type=int, nargs=3, default=[1,20,20])
    parser.add_argument("--lambda_values", help='Range of values for lambda (start, stop, step)',  type=float, nargs=3, default=[0., 1., 5])
